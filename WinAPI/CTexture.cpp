...
int CTexture::Load(const wstring& _FilePath, bool FullPath)
{
	wstring strContent;
	if (FullPath == false)
	{
		strContent = CPathMgr::GetContentPath();
		strContent += _FilePath;
	}
...
int CTexture::Load(const wstring& _FilePath, bool FullPath, HDC _hdc)
{
	wstring strContent;
	if (FullPath == false)
	{
...
void CTexture::Create(UINT _Width, UINT _Height, HDC _hdc)
{
