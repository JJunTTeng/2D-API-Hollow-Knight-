...
CLevel_Forgotten::CLevel_Forgotten()
{
}
...
void CLevel_Forgotten::Tick()
{
	CLevel::Tick();
}

void CLevel_Forgotten::FinalTick()
{
	CLevel::FinalTick();
}

void CLevel_Forgotten::Render()
{
	CLevel::Render();
}

void CLevel_Forgotten::End()
{
	DeleteAllObject();
}
